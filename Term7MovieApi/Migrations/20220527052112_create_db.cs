        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestrictedAge = table.Column<int>(type: "int", nullable: true),
                    PosterImageUrl = table.Column<string>(type: "varchar(200)", nullable: false),
                    CoverImageUrl = table.Column<string>(type: "varchar(200)", nullable: false),
                    TrailerUrl = table.Column<string>(type: "varchar(200)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PictureUrl = table.Column<string>(type: "varchar(200)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PromotionCode_PromotionType_PromotionTypeId",
                        column: x => x.PromotionTypeId,
                        principalTable: "PromotionType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromotionCode_Users_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Theaters_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QRCodeUrl = table.Column<string>(type: "varchar(200)", nullable: false),
                    StatusId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColumnPos = table.Column<int>(type: "int", nullable: false),
                    RowPos = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowTimeId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionCode_CustomerId",
                table: "PromotionCode",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_PromotionCode_PromotionTypeId",
                table: "PromotionCode",
